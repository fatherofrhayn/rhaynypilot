...
const int HYUNDAI_MAX_RT_DELTA = 336;          // max delta torque allowed for real time checks
const uint32_t HYUNDAI_RT_INTERVAL = 100000;   // 100ms between real time checks
